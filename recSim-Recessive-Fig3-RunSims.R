...
#  Linear C-delta relation
	...
	# sm = 0.1
GynK1.1  <-	recursionFwdSimLoop.oneLev(gen = 50000, dStar = 0.8, a = 1, b = 0.5, sm = 0.1, hf = 0.5, hm = 0.5, resolution = 0.1,
		                kMult = c(1.0), r.vals = c(0.0, 0.005, 0.01, 0.05), threshold = 1e-7)
