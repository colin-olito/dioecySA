...
#  Concave C-delta relation
	# dStar = 0.8, a = 0.2
		# sm = 0.1
			# all sims (TAKES A VERY LONG TIME)
			# k = kHat*1.1
				recursionFwdSimLoop.oneLev(gen = 500000, dStar = 0.8, a = 0.2, b = 0.5, sm = 0.1, hf = 0.5, hm = 0.5, resolution = 0.1,
										   kMult = c(1.1, 0.975, 0.95, 0.925, 0.90), r.vals = c(0.0, 0.005, 0.01, 0.05), threshold = 1e-7)
...
#  Linear C-delta relation
	...
	# sm = 0.1
	recursionFwdSimLoop.oneLev(gen = 25000, dStar = 0.8, a = 1, b = 0.5, sm = 0.1, hf = 0.25, hm = 0.25, resolution = 0.1, 
		                	   kMult = c(1.1, 0.975, 0.95, 0.925, 0.90), r.vals = c(0.0, 0.005, 0.01, 0.05), threshold = 1e-7)
...
#  Concave C-delta relation
	...
	# sm = 0.1
	recursionFwdSimLoop.oneLev(gen = 25000, dStar = 0.8, a = 0.2, b = 0.5, sm = 0.1, hf = 0.25, hm = 0.25, resolution = 0.1, 
		                kMult = c(1.1, 0.975, 0.95, 0.925, 0.90), r.vals = c(0.0, 0.005, 0.01, 0.05), threshold = 1e-7)
